...
export class Mark__versesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: string;
...
export class Mark extends ethereum.SmartContract {
  static bind(address: Address): Mark {
    return new Mark("Mark", address);
  }
  ...
  verses(param0: BigInt): Mark__versesResult {
    let result = super.call(
      "verses",
  ...
  try_verses(param0: BigInt): ethereum.CallResult<Mark__versesResult> {
    let result = super.tryCall(
      "verses",
      "verses(uint256):(uint256,uint256,uint256,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
